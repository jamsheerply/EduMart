function validateAddress() {
  ...
  if (firstName.trim() === "") {
    ...
    document.getElementById("firstNameError").textContent =
      "Frist Name should not exceed 32 characters";
    valid = false;
  }
  ...
  if (address.trim() === "") {
    ...
    document.getElementById("addressError").textContent =
      "Address should not exceed 32 characters";
    valid = false;
  }
  ...
  if (isNaN(postCode) || postCode.trim() === "" || postCode.length !== 6) {
    document.getElementById("postCodeError").textContent =
      "Post Code must be a 6-digit number";
    valid = false;
  } else if (lastName.length > 20) {
    document.getElementById("lastNameError").textContent =
      "Post Code should not exceed 20 characters";
    valid = false;
  }
  ...
  if (!phoneRegex.test(phone)) {
    ...
    document.getElementById("phoneError").textContent =
      "Phone should not exceed 20 characters";
    valid = false;
  }
